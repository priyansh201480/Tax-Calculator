...
// Shows modal on click of submit button if all inputs are valid. Calls tax calculator function for overall income and also show error icons if inputs are invalid
